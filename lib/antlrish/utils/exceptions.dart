...
class FhirPathExceptionNew implements Exception {
  ...
  FhirPathExceptionNew(this.message,
      {this.pathExpression,
      this.offset,
      this.token,
      this.cause,
  ...
  FhirPathExceptionNew copyWith({
    Object? context,
    Map? variables,
  }) {
    return FhirPathExceptionNew(
      message,
...
class FhirPathInvalidExpressionExceptionNew extends FhirPathExceptionNew {
  FhirPathInvalidExpressionExceptionNew(
    String message, {
...
class FhirPathDeprecatedExpressionExceptionNew extends FhirPathExceptionNew {
  FhirPathDeprecatedExpressionExceptionNew(
    String message, {
    String? pathExpression,
    int? offset,
    String? token,
...
class FhirPathEvaluationExceptionNew extends FhirPathExceptionNew {
  FhirPathEvaluationExceptionNew(
    String message, {
    String? pathExpression,
    Object? cause,
    String? operation,
